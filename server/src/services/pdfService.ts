...
export class PDFService {
   ...
   */
  static async generateRegistrationSlip(data: ApplicationSlipData): Promise<Buffer> {
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const verifyUrl = `${ENV.PUBLIC_APP_URL}/verify/${data.applicationId}`;
        ...
        doc
          ...
          .fillColor('#475569')
          .text(
            '1. This registration slip is an official electronic acknowledgement of your application submission for the Alwar Police Internship Programme 2026.\n' +
            ...
            '4. Scan the QR code above or visit the official portal with your Application ID to verify the live status of your application.',
            leftMargin + 10,
            footerY + 22,
